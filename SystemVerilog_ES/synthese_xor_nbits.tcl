...
set rtl_list [ list \
		   $rtl_dir/xor_nbits.sv\  
		  ]
		 #a modifier selon le fichier .sv dont on veut faire la synthèse
...
elaborate $top_name  -library LIB_RTL -parameters "nb_g=16"
